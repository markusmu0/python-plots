...
make_figure(width=10, height=7, unit="cm", other_axes=[0.17, 0.15, 0.95-0.15, 0.9-0.15], output_file=os.path.join(os.path.dirname(__file__), "example.pdf"), plots=plots, metadata={"Title" : "Testplot", "Subject" : "This is an example"})
# make_figure(width=10, height=7, unit="cm", other_axes=[0.17, 0.15, 0.95-0.15, 0.9-0.15], output_file=os.path.join(os.path.dirname(__file__), "example.pdf"), plots=plots, debug=True)
"""
